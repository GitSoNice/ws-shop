	...
	<body>
		<table width="100%" height="70%"  border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td width="100%" background="${pageContext.request.contextPath}/images/top_100.jpg" style="background-size: 100% 95%;">
				</td>
			</tr>
		</table>
...
// -->
  function exit(){
       window.open('${pageContext.request.contextPath}/adminlogin.htm','_top')
         } 
									</script> </font>
							</td>
							<td width="15%">
