		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><form:input type="text"
						path="username" id="username" cssClass="bg" /></td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					密码：</td>
				<td class="ta_01" bgColor="#ffffff"><form:input type="password"
						path="password" id="password" cssClass="bg" /></td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					真实姓名：</td>
				<td class="ta_01" bgColor="#ffffff"><form:input type="text"
						path="name" id="name" cssClass="bg" /></td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					邮箱：</td>
				<td class="ta_01" bgColor="#ffffff"><form:input type="text"
						path="email" id="email" cssClass="bg" /></td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					电话：</td>
				<td class="ta_01" bgColor="#ffffff"><form:input type="text"
						path="phone" id="phone" cssClass="bg" /></td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					地址：</td>
				<td class="ta_01" bgColor="#ffffff"><form:input type="text"
						path="addr" id="addr" cssClass="bg" /></td>
			</tr>
