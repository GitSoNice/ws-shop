				...
				<div class="dtree">
					...
					<script type="text/javascript">
						...
						d.add(
										...
										'0103',
										'二级分类管理',
										'${pageContext.request.contextPath}/listCategorySecond?catespage=0',
										'', 'mainFrame');
						d.add('0104', '01', '商品管理');
						d.add(
										'010401',
						...
						d.add(
										...
										'0105',
										'订单管理',
										'${pageContext.request.contextPath}/listOrder?opage=0',
										'', 'mainFrame');
						document.write(d);
					</script>
				</div>
